...
# Liqwids Services
This project was created using the WIM services liqwids. The WIM Services liqwids usage is outlined below:
## Installation of liqwids
[WIM.Services.Liqwids NuGet package](https://www.nuget.org/packages/WIM.Services.Liqwids/):`dotnet new -i WIM.Services.Liqwids`
