...
using LiqwidsAgent;
using LiqwidsServices.Controllers;
...
namespace LiqwidsServices.Test
{
    public class LiqwidsTest
    {
        public LiqwidsController controller { get; private set; }
        public LiqwidsTest() {
            //Arrange
            controller = new LiqwidsController(new InMemoryLiqwidsAgent());
    ...
    public class InMemoryLiqwidsAgent : ILiqwidsAgent
    {

        public List<Message> Messages => throw new NotImplementedException();

        public InMemoryLiqwidsAgent()
        {
